 ...
 *
 * This Class is the BolivarTech's representation of a polynomial whose
 * coefficients are elements of a Galois Fields. Instances of this class
 * are immutable.
 *
 * Esta clase implementa la representacion de un polinomio cuyos coeficientes
 * son elemento de un campos de Galois.
 *
 ...
 * @version 1.0.0
 */
final strictfp class GenericGFPoly {
     ...
     */
    public GenericGFPoly(GenericGF GField, int[] coefficients) {
